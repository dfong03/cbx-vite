...
//     useEffect(() => {
//         if (Redirect) {
//             if (ExternalRedirect) window.location.href = route;
//             else navigate(route);
//         }
//     }, [Redirect]);
...
//                         if (
//                             conjugate === null ||
//                             filters.has(conjugate) == false ||
//                             filters.get(conjugate) == false
//                         ) {
//                             return false;
//                         }
//                     }
...
//                                     filterLogic(stream.filters)
//                                         ? "visible"
//                                         : "hidden"
//                                 }`}
//                                 key={index}
//                                 onClick={() => {
//                                     setRoute(stream.path),
//                                         isExternalRedirect(stream.redirect),
//                                         setRedirect(true);
//                                 }}
//                             >
//                                 <div
//                                     className={`bg-[#1a1a22] bg-[url("../src/assets/Vector/FullStreamBG.svg")] bg-cover bg-no-repeat bg-center
...
//                                         <span className="text-center w-full text-xl font-bold -mb-6 mt-5">
//                                             {stream.title}
//                                         </span>
...
//                                                 className="h-full shrink mt-2"
//                                             />
//                                             <span>{stream.year[1]}</span>
//                                         </div>
//                                         <span className="p-2 text-center w-full text-sm tracking-widest font-semibold -mt-6">
//                                             {stream.subtitle}
//                                         </span>
//                                     </div>
//                                 </div>
